...
const Modal = ({opened, onClose, children, containerClassName, className}) => {
    ...
    return <div className={`w-screen h-screen bg-[rgba(0,0,0,.5)] fixed top-0 left-0 z-[999] transition-all p-1 px-3 ${modalOpened ? "flex" : "hidden"} ${showModal ? "opacity-100" : "opacity-0"}`}>

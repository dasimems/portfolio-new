...
const Nav = () => {
  ...
  return (
    <>
      ...
      >
        <button
          className="h-[40px] w-[40px] md:hidden inline-flex items-center justify-center"
          onClick={() => {
            if (mobileNavOpened) {
              setOpenMenu(false);
      ...
      >
        <div
          ref={mobileMenuRef}
          className={`special-scroll-vertical-two overflow-y-scroll absolute w-full max-w-[350px] duration-300 bg-white py-10 px-10 left-[1%] top-[80px] rounded-lg h-[calc(100%-90px)] flex flex-col gap-10 ${
            openMenu ? "translate-x-0" : "-translate-x-[150px]"
          }`}
        >

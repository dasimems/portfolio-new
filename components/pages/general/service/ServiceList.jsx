...
const ServiceList = ({horizontal, className}) => {
    ...
    return (
        ...
        <div className="relative">
            ...
            <div className={`flex flex-shrink-0 gap-6 special-scroll relative ${horizontal? "flex-row w-full special-scroll-horizontal" : "flex-col h-[400px] special-scroll-vertical"} ${className}`}>
            ...
            {!horizontal && <div className={`flex items-center w-full gap-6 absolute justify-center -bottom-[20px]`}>
            ...
            {horizontal && <div className={`flex items-center w-full gap-6 absolute justify-between top-1/2 -translate-y-1/2`}>
